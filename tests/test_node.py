...
class TestNode:
    ...
    def test_node_creation_with_loads(self):
        node = Node(
            coords=[1, 1, 1],
            F_x=1000,
            F_y=2000,
    ...
    def test_node_dof_identification(self):
        node = Node(
            coords=(0, 0, 0),
            u_x=0,
            theta_y=0
    ...
    def test_node_boundary_condition_list(self):
        node = Node(
            coords=(0, 0, 0),
            u_x=0,
            u_y=1,
    ...
    def test_node_mixed_conditions(self):
        node = Node(
            coords=np.array([1, 2, 3]),
            u_x=0,
            F_y=1000,
